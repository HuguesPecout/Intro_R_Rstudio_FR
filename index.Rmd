...
author: <h2 class="place">Base du langage, packages, Rstudio et documentation</h2>
date: <br><img src="figure/Rzine.png" width="240"/><br><h3 class="mail">hugues.pecout@cnrs.fr</h3><img src="figure/cnrs.png" width="80" style="float:left"/><img src="figure/cist-logo-bleu_sur_blanc.png" style="float:right" width="80"/>
output: 
...
#  {data-background="figure/calculatrice.png" data-background-size="450px"}
...
# Exemple avec le package "cartography"
...
#  {data-background="figure/tidy.jpg" data-background-size="500px"}
...
<div id="right_4">
<p class="legend3">[**cartography**](https://github.com/riatelab/cartography/)</p>
<p class="legend4">Cartographie thématique</p>
</div>
</div>
...
#  {data-background="figure/help.png" data-background-size="300px"}
...
browseVignettes("cartography")

```

<p align="left" ><img src="figure/vignettescarto.png"  width="500"/></p>
<p class="legend2" >Vignette du package [cartography](https://cran.r-project.org/web/packages/cartography/vignettes/cartography.html)</p>
</div>
...
<p class="legend3" >[**igraph**](https://igraph.org/redirect.html)</p>
...
<p class="moyp2">Conférences, groupes d'utilisateur.rice.s, manuels, blogs, forums, agrégateurs, MOODLE, MOOC, vidéos, listes de diffusion, réseaux sociaux...</p>

<p align="center"><img src="figure/rladies.png"  width="200"/></p>

<p class="moyp2">Il y en a pour tous les goûts !</p>
